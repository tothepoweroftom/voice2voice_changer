...
if __name__ == "__main__":
    ...
    voiceChangerManager.update_settings(
        "serverReadChunkSize", 1024
    )  # update chunk size
    voiceChangerManager.update_settings("tran", 22)  # update tune
    # The firt time is warm up
    output, perf = voiceChangerManager.changeVoice(
        warmup_data
