        ...
        try:
            ...
            if slot.embChannels == 256:
                if metadata["version"] == "2.1":
                    slot.version = "v1.1"  # 1.1 performs clip inside onnx.Disable realtime
                else:
                    slot.version = "v1"
            elif metadata["version"] == "2":
                slot.version = "v2"
            elif metadata["version"] == "2.1":  # 2.1 performs clip inside onnx.Disable realtime
                slot.version = "v2.1"
